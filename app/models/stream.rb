...
#     youtube_rtmps_ingestion_address.presence || youtube_ingestion_address
#   end

#   def youtube_backup_rtmp_url
#     youtube_rtmps_backup_ingestion_address.presence || youtube_backup_ingestion_address
#   end
...
#   # Important:
#   # Do NOT require youtube_video_id / youtube_watch_url here for upcoming schedule sync.
#   # Those may not exist yet while the stream is still scheduled or only partially live.
#   def youtube_sync_fields_present_when_synced
#     return unless synced?

#     errors.add(:youtube_broadcast_id, "can't be blank") if youtube_broadcast_id.blank?
#     errors.add(:youtube_stream_id, "can't be blank") if youtube_stream_id.blank?
#     errors.add(:youtube_stream_name, "can't be blank") if youtube_stream_name.blank?
#     errors.add(:youtube_ingestion_address, "can't be blank") if youtube_ingestion_address.blank?
#   end
# end
class Stream < ApplicationRecord
  belongs_to :youtube_channel
